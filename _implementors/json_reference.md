...
| `features` (currently in preview) | object | An object of [Dev Container Feature IDs](../../features) and related options to be added into your primary container. The specific options that are available varies by feature, so see its documentation for additional details. For example: <br />`"features": { "ghcr.io/devcontainers/features/github-cli": {} }` <br /><br /> ⚠️ Support is currently in preview as the [spec](../features) is not yet final. |
